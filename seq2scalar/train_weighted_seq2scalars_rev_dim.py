...
from transformer_constants import output_dim, d_model, nhead, num_encoder_layers, num_decoder_layers, \
...
val_dataset, _ = seq2scalar_32_rev(True, val_data, FEAT_COLS, TARGET_COLS, mean_x, std_x, mean_y, std_y, seq_variables_x,
                               scalar_variables_x, seq_variables_y, scalar_variables_y)
...
while patience < num_epochs:
    ...
    for idx, df in enumerate(batches):
        ...
        train_dataset, _ = seq2scalar_32_rev(True, df, FEAT_COLS, TARGET_COLS, mean_x, std_x, mean_y, std_y, seq_variables_x,
                                         scalar_variables_x, seq_variables_y, scalar_variables_y)
